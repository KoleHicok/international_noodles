...
<html lang="en">
    ...
    <head>
        <meta charset ="utf-8">
        <title>International Noodles!</title>
    ...
    <body>
        ...
        <section class="meat">
            ...
            <br>
            <br>
            In this site you will find many intriguing and interesting facts about certain countries and their foods. In addition to that, there are a few differnet recipes from different countries that you should definitely try out!</p>
        </section>
